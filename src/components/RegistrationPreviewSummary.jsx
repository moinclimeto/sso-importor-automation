    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-[0_2px_10px_rgba(0,0,0,0.04)] border border-slate-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-5">
          ...
          <InputField label="IEC" value={autoData?.iec} filePreviewPath={autoData?.iecDocumentPath} filePreviewName={autoData?.iecOriginalName} required />
          ...
          <FileField label="Representative picture of Plastic Packaging" filePath={autoData?.representativePicturePath} originalFileName={autoData?.representativePictureOriginalName} required />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-[0_2px_10px_rgba(0,0,0,0.04)] border border-slate-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
            <InputField label="Operating Status" value={generalInfo?.operatingStates?.[0] || 'MADHYA PRADESH'} required />
            <InputField label="Has Production Facility" value={generalInfo?.hasProductionFacility || 'Not Applicable'} required />
            <InputField label="Capital Invested (Cr.)" value={generalInfo?.capitalInvested || '100'} required />
            <InputField label="Compliance Status" value={generalInfo?.complianceStatus || 'Yes'} required />
          </div>
        </div>
      </div>
    </div>
