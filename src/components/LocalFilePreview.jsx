...
export default function LocalFilePreview({ filePath, fileName, previewUrl = '', originalFileName, hideText = false, onChangeDocument }) {
  ...
  }, [open, filePath, previewUrl, refresh, originalFileName, name]);
