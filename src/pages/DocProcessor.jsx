      ...
      {/* Categories Grid */}
        ...
        <div className="flex items-center justify-between mb-4 px-1 mt-2">
          ...
          <div className="flex items-center gap-4 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-100">
            <span className="text-xs font-medium text-slate-500 uppercase tracking-wider">Total Records: <span className="font-bold text-slate-700 ml-1">{totalRecords}</span></span>
            <div className="w-px h-3 bg-slate-300"></div>
            <span className="text-xs font-medium text-slate-500 uppercase tracking-wider">Categories: <span className="font-bold text-slate-700 ml-1">2</span></span>
          </div>
        </div>
